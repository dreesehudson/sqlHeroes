...
<body class="container-fluid">
    ...
    <form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='post'>
        ...
        <div class="row">
            ...
            if ($return->num_rows > 0) {
                ...
                while ($row = $return->fetch_assoc()) {
                    echo "<div class='col-3'><div class='form-check form-check-inline'> 
        ...
        <div class="form-group">
            ...
            <textarea required class="form-control" name="about" placeholder="Motto" rows="1"></textarea>
        </div>
        <div class="form-group">
            <h5 class="display-5 mt-3" for="exampleFormControlTextarea1">Biography
            </h5>
            <textarea required class="form-control" placeholder="How did you become a superhero?" name="bio" rows="3"></textarea>
        </div>
